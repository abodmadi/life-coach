...
export default function SectionHeader({ text1, text2, desc,flag=true }) {
  return (
    <div className={`     flex  flex-col  text-center md:text-right  border-b border-blueVeryDark-200 pb-6 ${flag&&"pt-24"}`}>
