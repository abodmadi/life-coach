...
export default function Button({ text, toPage }) {
  return (
    ...
    >
      <span className="absolute inset-0 border border-blueVeryDark-600 group-active:border-blueVeryDark-500"></span>
      <span className="block border border-blueVeryDark-600 bg-blueVeryDark-950 px-6 py-2 md:px-8 md:py-3 lg:px-10 lg:py-4 transition-transform active:border-blueVeryDark-500 active:bg-blueVeryDark-950 group-hover:-translate-x-1 group-hover:-translate-y-1">
        {text}
      </span>
    </Link>
  );
