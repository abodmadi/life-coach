...
export const academicDegreesList=[  
  {
    ...
    description:"أهمية الاهتمام بالصحة النفسية بدلاً من الإنجازات المادية فقط، والتي غالبًا ما تشعر بعدم الاكتمال. خصائص المدرب الماهر والمؤثر القادر على التأثير بشكل إيجابي على عملائه. كيفية عمل جلسات التدريب للسماح للعملاء بالتحرر من قيودهم وتحقيق أهدافهم، وكيف يمكن للمؤسسات الاعتماد على اللايف كوتشينج لتحسين أداء موظفيها.",
  },
  {
    date:"May-2023",
    title:"شهادة حل المشكلات واتخاذ القرارات",
    platform:"منصة إدراك",
    description:"تطوير المهارات في حل المشكلات واتخاذ القرارات يتطلب فهمًا عميقًا لمفهوم المشكلات بما في ذلك آليات وصفها وتحديدها بشكل دقيق. ففي عالم الأعمال المعاصر، يُعتبر فهم الطرق الفعالة لتحليل المشكلات وتقديم الحلول الإبداعية أمرًا حيويًا لنجاح الفرد والمؤسسة على حد سواء. ومن خلال تعلم تقنيات تحليل المشكلات، واكتساب مهارات اتخاذ القرارات الصائبة، يمكن للأفراد تعزيز أدائهم وتحسين قدرتهم على التفكير النقدي والابتكار.",
  },
  {
    date:"Mar-2023",
    title:"شهادة مدرب حياة معتمد",
    platform:"معهد الدراسات النفسية",
    description:"تمكنت من تطوير مهارات الاتصال والتواصل، فهم عميق للسلوك البشري، تطوير مهارات القيادة والتأثير، إدارة الوقت وتحديد الأولويات، مهارات حل المشكلات، التطوير الشخصي والمهني المستمر، بناء علاقات احترافية قوية، إدارة العمل الحر والتسويق للخدمات، التعامل مع التحديات العاطفية والنفسية، وتحقيق الأهداف الشخصية والمهنية.",
  },
  {
    date:"Jan-2023",
    title:"دورة الأمان التام",
    platform:"أكاديمية عمارة",
    description:"هذه العملية المطهرة تجلب معها شعوراً بالانفتاح والحرية، مما يمكننا من التقدم بخطوات واثقة نحو مستقبلٍ مشرق ومليء بالإنجازات. فعندما نتخلص من الخوف، نكسر قيودنا الذهنية ونمنح أنفسنا الفرصة للتطور والنمو الشخصي.",
  },
{
    date:"Jan-2022",
...
export const SkillsList= [
  {
    ...
    description:"مع سنوات من الخبرة في مجال التدريب الشخصي والمهني، أنا ملتزم بتقديم دعم فعال وتحفيزي لعملائي. خلال مسيرتي المهنية، عملت في مجموعة متنوعة من الأدوار والمهام التي ساعدتني على تطوير مجموعة شاملة من المهارات.",
    icon:gg,
  },
  {
    title:"المهارات الرئيسية",
    description:"كمدرب حياة محترف، أعتز بمجموعة المهارات التي طورتها عبر سنوات من الخبرة والتعلم المستمر. هذه المهارات تمكنني من توفير تجربة تدريبية فريدة ومؤثرة لعملائي.",
    icon:skill,
  },
  {
    title:"المعتقدات والقيم الأساسية",
    description:"كمدرب حياة، أعتبر معتقداتي وقيمي جزءًا لا يتجزأ من نهجي في التدريب وتوجيه عملائي. هذه المبادئ تشكل الأساس الذي أبني عليه علاقاتي المهنية وتحدد الطريقة التي أقدم بها خدماتي.",
    icon:ethics,
  },
  {
    title:"النهج الشخصي في التدريب",
    description:"كمدرب حياة، أتبنى نهجًا شخصيًا يركز على تعزيز القوة الداخلية وإمكانيات كل عميل. أؤمن بأن كل شخص لديه القدرة على تحقيق التغيير الإيجابي والنمو، ودوري هو مساعدتهم على اكتشاف هذه الإمكانيات وتحقيقها.",
    icon:abilities,
  },
  {
    title:"الهوايات والاهتمامات الشخصية",
    description:"بالإضافة إلى شغفي بالتدريب والتنمية الشخصية، لدي العديد من الهوايات والاهتمامات التي تثري حياتي وتساعد في الحفاظ على توازني الشخصي. هذه الأنشطة تساهم في تطويري كشخص وكمحترف.",
    icon:lifestyle,
  },
]
...
export const requestPaymentWaysList=[
  {
    title:"تسجيل الدخول",
    description:["تأكد من تسجيل الدخول أو إنشاء حساب جديد حتي تستطيع إكمال باقي الخطوات"],
  },
  {
    title:"أختر طريقة دفع",
    description:["حدد بأي طريقة تريد سداد القيمة المطلوبة","من خلال حساب فوري","من خلال حساب فودافون كاش"],
  },
  {
    title:"إرسال طلب الحجز",
    description:["قم بالضغط على (عن طريق الدفع الإلكتروني)","قم بملئ الحقول المطلوبة","تأكد من ارفاقك لصورة ايصال الدفع بجودة جيدة"],
  },
  {
    title:"مراجعة الطلب",
    description:["سيتم مراجعة الطلب وحين الانتهاء سيتم ابلاغك عن طريق رسالة بريد إلكتروني"],
  },
]