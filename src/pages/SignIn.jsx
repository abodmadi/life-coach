...
import { signInStart,signInSuccess,signInFailure } from '../redux/state_slices/user/user_slice.js'
        ...
        <>
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 ">
                <div className="mx-auto max-w-lg text-center">
                    <h1 className="text-2xl text-slate-800 font-bold sm:text-3xl">Welcome Back! 👋</h1>
                ...
                <form onSubmit={handelSubmit} className="mx-auto mb-0 mt-8 max-w-md space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <span className="absolute inset-y-0 end-0 grid place-content-center px-4">
                                ...
                                >
                                    ...
                                    />
                                    {isHidden?null:<line x1="1" y1="1" x2="23" y2="23"></line>}
                                </svg>
                            </span>
                        </div>
                    </div>
