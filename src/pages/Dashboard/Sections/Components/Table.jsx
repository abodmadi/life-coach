...
export default function Table({
  ...
  const [itemsPerPage, setBlogsPerPage] = useState(10);
    ...
    <>
      <div className="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
        <div className="mb-1 w-full">
          ...
          {/* Section 2 */}
          <div className="block gap-x-4 sm:flex items-center md:divide-x md:divide-gray-100">
            {/* Search Form */}
            ...
            <div className="flex items-center sm:justify-end w-full">
              <button
                type="button"
                onClick={() => setIsAddNewDialogClicked(true)}
                  ...
                  <tr>
                    {tableColumnsNames.map((column, index) => (
                      <th
                        key={index}
                        scope="col"
                        className="p-2 whitespace-nowrap text-right text-md font-medium text-gray-500 uppercase"
                      >
                        {column}
                      </th>
                    ))}
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  ...
                  {currentItems?.map((row, index) => (
                    <tr key={index} className="hover:bg-gray-100">
                      <td className="p-2 text-center whitespace-nowrap text-base font-medium text-gray-900">
                        {index + 1}
                      </td>
                      <td className="flex flex-col translate-y-3 items-center justify-center ">
                        <img
                          className="object-cover size-10 rounded-full shadow-sm"
                          src={row?.coverImage}
                          alt={`course image ${index}`}
                        />
                      </td>
                      <td className="p-2 text-base font-medium text-gray-900">
                        <p className="line-clamp-2 min-w-28">{row?.name}</p>
                      </td>
                      <td className="p-2 text-base font-medium text-gray-900">
                        <p className="line-clamp-3 min-w-40">
                          {row?.description}
                        </p>
                      </td>
                      {hide ? (
                      ...
                      <td className="p-4 flex gap-x-2 whitespace-nowrap space-x-2">
                        <button
                          type="button"
                          onClick={() => {
